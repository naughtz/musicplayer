...
class PlayerCreator {
	...
	this.musics.getSongByNum(0).songUrl = document.getElementById('musicplayer').getAttribute('songUrl');
        this.musics.getSongByNum(0).title = document.getElementById('musicplayer').getAttribute('title');
	this.musics.getSongByNum(0).singer = document.getElementById('musicplayer').getAttribute('singer');
        this.musics.getSongByNum(0).imageUrl = document.getElementById('musicplayer').getAttribute('imageUrl');
